...
export declare class AuthService {
    ...
    private readonly avatarGenerator;
    constructor(userModel: Model<User>, solanaService: SolanaService, avatarGenerator: AvatarGenerator);
    createUser(createUserDto: CreateUserDto): Promise<import("mongoose").Document<unknown, {}, User> & User & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    login(authRequestDto: AuthRequestDto): Promise<{
        token: any;
    }>;
    decodeHash(hash: string): Promise<DecotedHashDto>;
